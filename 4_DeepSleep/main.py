...
save_nvram = True                   # Save LoRaWAN state, required for correct packet arrival at TTN server
...
def connect():
    ...
    if save_nvram:
        lora.nvram_restore()
        lora.nvram_erase() # Problems with faulty state after switching power source
